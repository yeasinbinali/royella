    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className='absolute w-1/2 ml-24 mt-40'>
                    <h1 className='text-6xl text-complex font-bold'>Your Gateway to Tailored Accommodations</h1>
                    <p className='text-lg text-complex my-10'>Explore a world of personalized comfort with Royella. Our platform offers a diverse range of hotel rooms suited to your unique preferences and needs. From cozy boutique stays to spacious suites with panoramic views, find the perfect room for your next adventure with ease.</p>
                    <button className='btn bg-main text-complex border-none text-lg font-bold'>Get in touch</button>
                </div>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className='absolute w-1/2 ml-24 mt-40'>
                    ...
                    <p className='text-lg text-complex my-10'>Elevate your travel experience with Royella. Our platform offers a seamless booking process for a wide range of hotel rooms, ensuring you find the perfect match for your preferences and budget. From chic urban hideaways to serene seaside retreats, unlock a world of possibilities and make your next stay unforgettable.</p>
                    <button className='btn bg-main text-complex border-none text-lg font-bold'>Get in touch</button>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 right-5 bottom-0">
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className='absolute w-1/2 ml-24 mt-40'>
                    ...
                    <p className='text-lg text-complex my-10'>Fulfill your SuiteDreams with our platform dedicated to exceptional hotel rooms. Whether you desire a lavish suite or a charming boutique room, we've got you covered. Discover the perfect blend of style, comfort, and luxury, and make your next stay a dream come true.</p>
                    <button className='btn bg-main text-complex border-none text-lg font-bold'>Get in touch</button>
                </div>
                <div className="absolute flex justify-between transform -translate-y-1/2 right-5 bottom-0">
